...
function oldestScript(scripts) {
    return scripts.reduce((a, b) => (a.year < b.year && b.living) ? a : b)
}

console.log(oldestScript(SCRIPTS)) // {name: "Phoenician", ...}

function oldestLivingScript(scripts) {
    return scripts.filter(s => s.living).reduce((a, b) => (a.year < b.year) ? a : b)
}
